	...
	wave = function(palette)
		return {
			ui = {
				...
				bg_m3 = palette.sumiInk4,
				bg_m2 = palette.sumiInk2,
				bg_m1 = palette.sumiInk3,
				bg = palette.sumiInk1,
				bg_p1 = palette.sumiInk0,
				bg_p2 = palette.sumiInk4,

				special = palette.springViolet1,
				nontext = palette.sumiInk6,
				whitespace = palette.sumiInk3,
			...
			syn = {
				...
				variable = palette.fujiGray,
				number = palette.sakuraPink,
				constant = palette.dragonAsh,
				identifier = palette.lotusTeal3,
				-- parameter  = "#C3B1B1",
				-- parameter  = "#B1ADC8",
				-- parameter  = "#b8b4d0",
