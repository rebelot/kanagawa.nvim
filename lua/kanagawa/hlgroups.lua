...
function M.setup(colors, config)
    ...
    local hlgroups = {
        ...
        MiniStatuslineInactive = { fg = colors.fg_comment, bg = colors.bg_status },
        MiniStatuslineModeCommand = { fg = colors.bg_dark, bg = colors.op, bold = true },
        MiniStatuslineModeInsert = { fg = colors.bg_dark, bg = colors.git.added, bold = true },
        MiniStatuslineModeNormal = { fg = colors.bg_dark, bg = colors.fn, bold = true },
        MiniStatuslineModeOther = { fg = colors.bg_dark, bg = colors.dep, bold = true },
        MiniStatuslineModeReplace = { fg = colors.bg_dark, bg = colors.git.removed, bold = true },
        MiniStatuslineModeVisual = { fg = colors.bg_dark, bg = colors.kw, bold = true },
