...
(autothemer-deftheme
 ...
 (
  ...
  (diredfl-number                                (:foreground oniViolet))
  (diredfl-date-time                             (:foreground sakuraPink))
  (diredfl-dir-name                              (:foreground waveAqua2))
  (diredfl-symlink                               (:foreground autumnYellow))
  (diredfl-read-priv                             (:foreground crystalBlue))
  (diredfl-write-priv                            (:foreground springViolet2))
  (diredfl-exec-priv                             (:foreground springBlue))
