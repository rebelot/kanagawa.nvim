...
(autothemer-deftheme
 ...
 (
  ...
  (diredfl-file-name                             (:foreground lotusWhite3))
  (diredfl-file-suffix                           (:foreground lotusGreen2))
  (diredfl-number                                (:foreground lotusViolet1))
  (diredfl-date-time                             (:foreground lotusPink))
  (diredfl-dir-name                              (:foreground lotusAqua))
  (diredfl-symlink                               (:foreground lotusYellow2))
  (diredfl-read-priv                             (:foreground lotusBlue4))
  (diredfl-write-priv                            (:foreground lotusTeal2))
  (diredfl-exec-priv                             (:foreground lotusBlue2))
  (diredfl-dir-priv                              (:foreground lightBlue))
  (diredfl-no-priv                               (:foreground lotusBlue1))
  (diredfl-rare-priv                             (:foreground lotusBlue2))
